...
const Footer = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_bi8bdxk', 'template_g7sut8h', form.current, '9TxjdW2hPIUQLRauL')
      .then((result) => {
      ...
      <div id="contact" className="container section">
        ...
        <div className="row contacts">
          <div className="col-md-3 col-lg-4">
            <div className="contacts__list">
              <dl className="contact-list">
                <dt>Phone:</dt>
                <dd><a href="+880 1724504184">+880 1724504184</a></dd>
                <dt>Wechat:</dt>
                <dd><a href="Wechat:rasedhasan">Md Rased Hasan</a></dd>
                <dt>Email:</dt>
                <dd><a href="mailto:rasedk434@gmail.com">rasedk434@gmail.com</a></dd>
              </dl>
            </div>
          </div>
          ...
          <div className="contacts__social col-md-3 pt-4 pt-md-0">
            <ul>
              <li><a href="https://github.com/rased-hasan-apu" target="_blank"><i className="fa fa-github"></i> GitHub</a></li>
              <li><a href="https://www.linkedin.com/in/md-rased-hasan-41820b227/" target="_blank"><i className="fa fa-linkedin-square"></i> Linkedin</a></li>
              <li><a href="https://web.facebook.com/profile.php?id=100006751386476" target="_blank"><i className="fa fa-facebook-square"></i> Facebook</a></li>
              <li><a href="https://www.instagram.com/rasedk434/" target="_blank"><i className="fab fa-instagram"></i> Instagram</a></li>
            </ul>
          </div>
          <div className="footer ps-md-5 ms-md-5 mt-5">
            <p>@copy; 2021 Md Rased hasan. All Rights Reserved</p>
          </div>
        </div>
      </div>
    </div>
